...
object ListenTogetherServers {
    private const val SERVER_JSON_URL = "https://raw.githubusercontent.com/harikarthick12/Luvora/refs/heads/main/app/server.json"

    private val _servers = MutableStateFlow(
        listOf(
            ListenTogetherServer(
                name = "Luvora Server",
                url = "https://devilmi-vivi-music-listen-together.hf.space",
                location = "Global - Luvora",
                operator = "ECHO"
            )
        )
    )
