package com.snuggle.music.engine

import androidx.media3.common.MediaItem
import androidx.media3.common.Player
import com.snuggle.music.data.EchoBrainRepository
...
import com.snuggle.music.db.DatabaseDao
import com.snuggle.music.engine.brain.FlowNeuroEngine
import com.snuggle.music.engine.brain.InteractionType
        ...
        scope.launch {
            isEnabled.collectLatest { enabled ->
                if (!enabled) {
                    ...
                    // Remove Luvora Brain items from the queue
